angular.module('app.complicated', [])
    .controller("ComplicatedController", ['$stateParams',ComplicatedController]);

function ComplicatedController($stateParams) {
